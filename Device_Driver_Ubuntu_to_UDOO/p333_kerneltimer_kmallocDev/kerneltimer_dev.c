...
typedef struct
{
	...
	unsigned long 	  led;
	unsigned long	  key;	//추가
} __attribute__ ((packed)) KERNEL_TIMER_MANAGER;

//static KERNEL_TIMER_MANAGER* ptrmng = NULL;
//ptrmg를 전역변수로 선언했는데 다시 매개변수로 받는것은 옳지 않다
//동적 할당을 활용하자
...
static int key_init(void)			//추가 (led_init 활용하여 작성)
{
	int ret = 0;
	int i;
...
static ssize_t ledkey_write (struct file *filp, const char *buf, size_t count, loff_t *f_pos)
{
	...
	//void 포인터를 커널 타이머 포인터로 형 변환을 해서 사용함
//  get_user(kbuf,buf);
...
//******************** file_opreations struct 복사_ ledkey_fops 를 사용하기 위해 *********************//
...
//******************** file_operation struct END****************************************************//



//*********************************************************************************************//
//								COPY LEDKEY_FUNCTIONS... END								   //
//*********************************************************************************************//
