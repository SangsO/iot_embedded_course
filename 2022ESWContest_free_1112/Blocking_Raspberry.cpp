        ...
        if (serialDataAvail(fd)) {
            ...
            if (newChar == 'S') {
                ...
                while (1) {
                    ...
                    cv::Mat origin_img = cv::imread("/home/kshksh/ksh_rasp/images/test1.jpg", 0);
                    cv::resize(origin_img, origin_img, cv::Size(640, 480));
                ...
                //sprintf(send_msg, "%s@%d@%sL", number_back, type, spot);
                int i = 0;
